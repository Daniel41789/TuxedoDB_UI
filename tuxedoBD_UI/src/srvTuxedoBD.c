...
"select idDoctor ,Nombre ,Apellido ,Especialidad  from doctores where Nombre=\
:b0           ";
...
{13,4130,1,0,0,
5,0,0,0,0,0,27,60,0,0,4,4,0,2,8,68,65,78,73,69,76,65,82,1,97,0,0,1,97,0,0,1,97,
0,0,1,10,0,0,
44,0,0,2,0,0,30,70,0,0,0,0,0,2,8,68,65,78,73,69,76,65,82,
67,0,0,3,0,0,32,74,0,0,0,0,0,2,8,68,65,78,73,69,76,65,82,
90,0,0,4,84,0,3,139,0,0,4,4,0,2,8,68,65,78,73,69,76,65,82,1,3,0,0,1,97,0,0,1,
97,0,0,1,97,0,0,
129,0,0,5,90,0,9,208,0,0,1,1,0,2,8,68,65,78,73,69,76,65,82,1,97,0,0,
156,0,0,5,0,0,13,215,0,0,4,0,0,2,8,68,65,78,73,69,76,65,82,2,3,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,
195,0,0,5,0,0,13,228,0,0,4,0,0,2,8,68,65,78,73,69,76,65,82,2,3,0,0,2,97,0,0,2,
97,0,0,2,97,0,0,
234,0,0,5,0,0,15,232,0,0,0,0,0,2,8,68,65,78,73,69,76,65,82,
257,0,0,6,58,0,5,279,0,0,2,2,0,2,8,68,65,78,73,69,76,65,82,1,97,0,0,1,3,0,0,
288,0,0,7,53,0,2,335,0,0,1,1,0,2,8,68,65,78,73,69,76,65,82,1,3,0,0,
};
...

{
    ...
    sqlstm.sqladtp = &sqladt;
    sqlstm.sqltdsp = &sqltds;
    sqlstm.stmt = "insert into pacientes (idPaciente,Nombre,Apellido,Telefon\
o) values (:b0,:b1,:b2,:b3)";
    sqlstm.iters = (unsigned int  )1;
    ...
    sqlstm.sqlety = (unsigned short)4352;
    sqlstm.occurs = (unsigned int  )0;
    sqlstm.sqhstv[0] = (unsigned char  *)&t_idPaciente;
    ...
    sqlstm.sqadto[0] = (unsigned short )0;
    sqlstm.sqtdso[0] = (unsigned short )0;
    sqlstm.sqhstv[1] = (unsigned char  *)t_Nombre;
    ...
    sqlstm.sqadto[1] = (unsigned short )0;
    sqlstm.sqtdso[1] = (unsigned short )0;
    sqlstm.sqhstv[2] = (unsigned char  *)t_Apellido;
    ...
    sqlstm.sqadto[2] = (unsigned short )0;
    sqlstm.sqtdso[2] = (unsigned short )0;
    sqlstm.sqhstv[3] = (unsigned char  *)t_Telefono;
...

{
   ...
   sqlstm.sqhstv[0] = (unsigned char  *)t_Nombre;
...

{
   ...
   sqlstm.sqhstv[0] = (unsigned char  *)&t_idDoctor;
   sqlstm.sqhstl[0] = (unsigned long )sizeof(int);
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         short *)0;
   sqlstm.sqinds[0] = (         int  )0;
   ...
   sqlstm.sqadto[2] = (unsigned short )0;
   sqlstm.sqtdso[2] = (unsigned short )0;
   sqlstm.sqhstv[3] = (unsigned char  *)t_Especialidad;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "update habitaciones  set Nombre=:b0 where idHabitacion=:b1";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (unsigned char  *)&t_idHabitacion;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "delete  from especialidades  where idEspecialidad=:b0";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqlety = (unsigned short)4352;
   sqlstm.occurs = (unsigned int  )0;
   sqlstm.sqhstv[0] = (unsigned char  *)&t_idEspecialidad;
   sqlstm.sqhstl[0] = (unsigned long )sizeof(int);
   sqlstm.sqhsts[0] = (         int  )0;
   sqlstm.sqindv[0] = (         short *)0;
   sqlstm.sqinds[0] = (         int  )0;
